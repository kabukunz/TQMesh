...
// this gives a sliver tris
//   domain.add_fixed_vertex(0.5, 1.0, 0.5, 0.5);
//   domain.add_fixed_vertex(0.5, 2.0, 0.5, 0.5);

//   domain.add_fixed_vertex(2.5, 2.5);

  domain.add_fixed_vertex(0.5, 1.0, 0.25);
  domain.add_fixed_vertex(0.5, 2.0, 0.25);
  ...
  { source_dir + "/auxiliary/example_data/Example_10" };
